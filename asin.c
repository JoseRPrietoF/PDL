...
static const yytype_uint16 yyrline[] =
{
      ...
      52,    53,    56,    57,    60,    68,    84,    88,    94,    98,
      99,   100,   101,   104,   105,   108,   110,   116,   127,   136,
     146,   135,   159,   168,   158,   177,   184,   188,   183,   202,
     201,   215,   220,   252,   283,   288,   314,   319,   336,   341,
     357,   363,   382,   387,   402,   408,   434,   448,   454,   470,
     490,   498,   504,   510,   517,   518,   519,   520,   521,   526,
     527,   528,   529,   532,   533,   537,   538,   539,   542,   543,
     544
};
#endif
...
static const yytype_int16 yydefgoto[] =
{
      ...
      29,    53,    30,    31,    32,   114,   124,   127,   132,   134,
...
static const yytype_uint8 yytable[] =
{
     ...
     113,   115,    18,    19,   116,   122,   121,    20,    21,   130,
      ...
      17,    11,    87,    12,    13,    14,   129,    60,   131,    95,
...
#line 1852 "asin.c" /* yacc.c:1646  */
  ...
  case 53:
#line 388 "./src/asin.y" /* yacc.c:1646  */
    {
...
#line 1869 "asin.c" /* yacc.c:1646  */
  ...
  case 54:
#line 403 "./src/asin.y" /* yacc.c:1646  */
    {
...
#line 409 "./src/asin.y" /* yacc.c:1646  */
    {
              ...
              if((yyvsp[0].atributos).tipo == T_ENTERO && (yyvsp[-1].op) != OPMAS_ && (yyvsp[-1].op) != OPREST_){
                ...
                if((yyvsp[0].atributos).tipo == T_ENTERO){ 
					...
					(yyval.atributos).tipo = T_LOGICO;
					(yyval.atributos).pos = creaVarTemp();
					emite(ESUM,crArgPos((yyvsp[0].atributos).pos), crArgEnt(1), crArgPos((yyval.atributos).pos));  /* $$ = $2 + 1 */
					emite(RESTO,crArgPos((yyval.atributos).pos), crArgEnt(2), crArgPos((yyval.atributos).pos)); /* $$ = $$ % 2 */
				}
              }
...
#line 471 "./src/asin.y" /* yacc.c:1646  */
    {
                  ...
                  if ((yyvsp[-1].atributos).tipo == T_ENTERO) {
                    ...
                    // Generacion de codigo intermedio
					(yyval.atributos).pos = creaVarTemp();
					emite(ESUM, crArgEnt(sim.desp) ,  crArgPos((yyvsp[-1].atributos).pos) , crArgPos((yyval.atributos).pos));
                    emite(EAV, crArgPos(sim.desp), crArgPos((yyval.atributos).pos), crArgPos((yyval.atributos).pos));
...
#line 2029 "asin.c" /* yacc.c:1646  */
  ...
  case 66:
#line 519 "./src/asin.y" /* yacc.c:1646  */
    {(yyval.op) = EDIF; }
...
#line 2053 "asin.c" /* yacc.c:1646  */
  ...
  case 70:
#line 527 "./src/asin.y" /* yacc.c:1646  */
    {(yyval.op) = EMEN; }
#line 2059 "asin.c" /* yacc.c:1646  */
    break;
...
#line 537 "./src/asin.y" /* yacc.c:1646  */
    {(yyval.op) = EMULT; }
#line 2089 "asin.c" /* yacc.c:1646  */
    break;

  case 76:
#line 538 "./src/asin.y" /* yacc.c:1646  */
    {(yyval.op) = EDIVI; }
...
#line 548 "./src/asin.y" /* yacc.c:1906  */
